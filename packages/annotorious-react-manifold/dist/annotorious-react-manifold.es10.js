import { __exports as m } from "./annotorious-react-manifold.es12.js";
...
function ir() {
  return he ? m : (he = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function je(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === _ || e === N || Se || e === U || e === k || e === D || Oe || e === Re || Ce || Pe || we || typeof e == "object" && e !== null && (e.$$typeof === F || e.$$typeof === C || e.$$typeof === B || e.$$typeof === q || e.$$typeof === T || // This needs to include all possible module reference object
...
` + a[s].replace(" at new ", " at ");
    ...
    function Ne(e, r) {
      if (typeof e.ref == "string" && R.current && r && R.current.stateNode !== r) {
        ...
        Y[t] || (l('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', d(R.current.type), e.ref), Y[t] = !0);
      }
    }
    function Be(e, r) {
      {
    ...
    function ze(e, r, t, n, o) {
      {
        ...
        return Ge(e, a, c, o, n, R.current, i);
      }
    }
...
Check the top-level render call using <` + t + ">.");
    ...
    var er = Qe, rr = Ze;
    m.Fragment = _, m.jsx = er, m.jsxs = rr;
  }(), m);
}
export {
  ir as __require
