...
class F {
  ...
  createGPUBuffer(e) {
    ...
    return e._updateID = 0, e.data && (ie(e.data.buffer, t.getMappedRange()), t.unmap()), this._gpuBuffers[e.uid] = t, this._managedBuffers.push(e), t;
  }
  onBufferChange(e) {
...
class N {
  constructor(e) {
    ...
    for (let r = 0; r < t; r++) {
      ...
      r === 0 && (s |= S.COPY_SRC), this._buffers.push(new ne({
...
class J {
  ...
  initSource(e) {
    ...
    const r = X[e.format] || { blockBytes: 4, blockWidth: 1, blockHeight: 1 }, s = Math.ceil(e.pixelWidth / r.blockWidth) * r.blockWidth, i = Math.ceil(e.pixelHeight / r.blockHeight) * r.blockHeight, n = {
      label: e.label,
  ...
  generateCanvas(e) {
    const t = this._renderer, r = t.gpu.device.createCommandEncoder(), s = ue.get().createCanvas();
