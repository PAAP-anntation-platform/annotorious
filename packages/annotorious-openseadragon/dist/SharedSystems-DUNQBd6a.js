...
class Qe extends Ye {
  constructor(e) {
    const { sprite: t, ...r } = e, a = new Ge(t.texture), n = new re({
...
class Gt {
  ...
  _initRenderTarget(e) {
    let t = null;
    return U.test(e) && (e = de(e)), e instanceof I ? t = e : e instanceof _ && (t = new I({
      colorTextures: [e]
...
function be(s, e, t) {
  ...
  ), t && j(s, a, t)) : (t = s._updateFlags, s.relativeGroupTransform.copyFrom(r), t && j(s, lt, t)), !s.isRenderGroupRoot) {
...
class ke {
  ...
  _beginAdvancedBlendMode(e) {
    ...
    this._filterHash[t] || (this._filterHash[t] = new K({
      filters: [new y[t]()]
    }));
    const r = {
      renderPipeId: "filter",
...
const gt = new w(), xt = new q(), vt = [0, 0, 0, 0];
class Ce {
  constructor(e) {
    this._renderer = e;
  }
  ...
  generateTexture(e) {
    ...
    let n = e.clearColor;
    n ? n = Array.isArray(n) && n.length === 4 ? n : J.shared.setValue(n).toArray() : n = vt;
    const i = ((d = e.frame) == null ? void 0 : d.copyTo(gt)) || Le(a, xt).rectangle;
...
class D {
  ...
  init(e) {
    if (e.hello) {
      ...
      this._renderer.type === se.WEBGL && (t += ` ${this._renderer.context.webGLVersion}`), bt(t);
    }
  }
}
D.extension = {
