  ...
  activateVao(e, r) {
    ...
    for (const c in i) {
      ...
      if (d) {
        ...
        const E = Q(u.format), H = ke(u.format);
...
class Et {
  constructor(e) {
    this.target = ie.TEXTURE_2D, this.texture = e, this.width = -1, this.height = -1, this.type = f.UNSIGNED_BYTE, this.internalFormat = y.RGBA, this.format = y.RGBA, this.samplerType = 0;
  }
}
const bt = {
  id: "image",
